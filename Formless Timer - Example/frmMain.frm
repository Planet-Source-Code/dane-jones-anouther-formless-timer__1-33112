...
'** Define Timer Objects
    Private WithEvents MyTimer0 As clsTimer
Attribute MyTimer0.VB_VarHelpID = -1
    Private WithEvents MyTimer1 As clsTimer
Attribute MyTimer1.VB_VarHelpID = -1
    Private WithEvents MyTimer2 As clsTimer
 ...
 ************************
    ...
    Private Sub Form_Load()
        '** Display Author Message
            MsgBox Replace(App.Comments, "<br>", vbCrLf), vbInformation, "Author's Notes"
            
        '** Create Timer Objects
            Set MyTimer0 = New clsTimer
            Set MyTimer1 = New clsTimer
            Set MyTimer2 = New clsTimer
